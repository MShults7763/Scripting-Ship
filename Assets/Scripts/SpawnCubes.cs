// Matt Shults Fall semester 2023
// this code will spawn cubes around the map

// challenge #2
// create an array of names
// assign a random name to each new cube
// bonus (append a new number to each duplicate name. e.g. tom2, betty4) (I won't even try it)


// homework: use an array of colors to choose the random color of your cubes. (Bonus: Every name is the same color
// homework: change  collectCubes() to a coruntine that uses WaitUntilEndOfFrame();
